...
const Footer = () => (
  <footer className="w-full bg-[#222] text-white pb-4 pt-0 px-0 mt-0">
    ...
    <div className="w-full mx-auto flex flex-col md:flex-row justify-between items-start gap-8 px-2 pt-2">
      ...
      <div className="flex flex-col gap-1 basis-full md:basis-1/3 flex-1">
        <div className="flex flex-col gap-[2px] text-[11px] text-gray-300">
          ...
          <div className="flex items-center gap-2">
            ...
            <a href="https://facebook.com/actionsportarmenia" target="_blank" rel="noopener noreferrer" className="hover:text-white">facebook.com/actionsportarmenia</a>
          </div>
          {/* Email */}
          <div className="flex items-center gap-2">
            <svg className="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
            ...
            <a href="mailto:armeniaasr@gmail.com" className="hover:text-white">armeniaasr@gmail.com</a>
          </div>
          {/* Телефон */}
          <div className="flex items-center gap-2">
            <svg className="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
            ...
            <a href="tel:+374-44-999-432" className="hover:text-white">+374-44-999-432</a>
          </div>
          <img
          src="/logo.png"
